...
const MovieDetails = () => {
  ...
  // bringing data from redux (by using useSelector hook then from state.movie (from movie reducer))
      ...
      className='relative w-screen h-[180vh] px-[10%]'>
        ...
        <div className="w-full flex text-white">
          ...
          <div className='content ml-[5%]'>
            ...
            <h1 className='text-5xl font-black text-white '>{info.detail.name || info.detail.title || info.detail.original_title || info.detail.original_name} <small className='text-2xl font-bold text-zinc-200'>({info.detail.release_date.split("-")[0] })</small>
            </h1>
        ...
        <h1 className='text-3xl font-bold text-white'>Movie Recommendations & Similar Movies </h1>      
